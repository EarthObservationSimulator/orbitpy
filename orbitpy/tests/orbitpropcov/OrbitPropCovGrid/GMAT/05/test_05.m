...
GMAT Test_01_SC.SMA = 7578.378000000001;
GMAT Test_01_SC.ECC = 5.080456762991289e-16;
GMAT Test_01_SC.INC = 180;
GMAT Test_01_SC.RAAN = 0;
GMAT Test_01_SC.AOP = 0;
GMAT Test_01_SC.TA = 254.69019;
...
GMAT DefaultOrbitView.UpperLeft = [ 0.2579957356076759 0.05225225225225225 ];
GMAT DefaultOrbitView.Size = [ 0.9957356076759062 0.9441441441441442 ];
GMAT DefaultOrbitView.RelativeZOrder = 55;
...
GMAT DefaultGroundTrackPlot.UpperLeft = [ 0.2579957356076759 0.05225225225225225 ];
GMAT DefaultGroundTrackPlot.Size = [ 0.9957356076759062 0.9441441441441442 ];
