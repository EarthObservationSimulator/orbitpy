...
GMAT Test_01_SC.SMA = 6999.999999999999;
GMAT Test_01_SC.ECC = 6.28438903382245e-16;
GMAT Test_01_SC.INC = 10.00000000000005;
GMAT Test_01_SC.RAAN = 360;
GMAT Test_01_SC.AOP = 0;
GMAT Test_01_SC.TA = 353.56998;
...
Propagate 'Propagate_355_RAAN' OrbitPy_Propagator_J2(Test_01_SC) {Test_01_SC.EarthMJ2000Eq.RAAN = 355};
