...
class TestOrbitPropCovGrid(unittest.TestCase):
    ...
    def test_run_1(self):
        ...
        # Setup IO file paths
        prop_cov_param.cov_grid_fl = self.dir_path + "/STK/test_STK_coverage/Accesses/Global_Grid.csv"
    ...
    def test_run_4(self):
        ...
        # Setup IO file paths
        prop_cov_param.cov_grid_fl = self.dir_path + "/STK/test_STK_coverage/Accesses/US_Grid.csv"
    ...
    def test_run_7(self):
        ...
        # Setup IO file paths
        prop_cov_param.cov_grid_fl = self.dir_path + "/STK/test_STK_coverage/Accesses/Equatorial_Grid.csv"
