...
class TestOrbitPropCovGrid(unittest.TestCase):
    ...
    def test_run_1(self):
        ...
        stk_sat_state_fl = self.dir_path + "/STK/01/states.txt"
    ...
    def test_run_2(self):
        ...
        # Read in state data to numpy array
        stk_sat_state_fl = self.dir_path + "/STK/02/states.txt"
        orbitpyData = TestOrbitPropCovGrid.orbitpyStateArray(prop_cov_param.sat_state_fl)
        stkData = TestOrbitPropCovGrid.stkStateArray(stk_sat_state_fl)   
    ...
    def test_run_3(self):
        ...
        # Read in state data to numpy array
        stk_sat_state_fl = self.dir_path + "/STK/03/states.txt"
        orbitpyData = TestOrbitPropCovGrid.orbitpyStateArray(prop_cov_param.sat_state_fl)
        stkData = TestOrbitPropCovGrid.stkStateArray(stk_sat_state_fl)  
    ...
    def test_run_4(self):
        ...
        # Read in state data to numpy array
        stk_sat_state_fl = self.dir_path + "/STK/04/states.txt"
        orbitpyData = TestOrbitPropCovGrid.orbitpyStateArray(prop_cov_param.sat_state_fl)
        stkData = TestOrbitPropCovGrid.stkStateArray(stk_sat_state_fl)
    ...
    def test_run_5(self):
        ...
        # Read in state data to numpy array
        stk_sat_state_fl = self.dir_path + "/STK/05/states.txt"
        orbitpyData = TestOrbitPropCovGrid.orbitpyStateArray(prop_cov_param.sat_state_fl)
        stkData = TestOrbitPropCovGrid.stkStateArray(stk_sat_state_fl)
    ...
    def test_run_6(self):
        ...
        stk_sat_state_fl = self.dir_path + "/STK/06/kepler_states.txt"
    ...
    def test_run_8(self):
        ...
        stk_sat_state_fl = self.dir_path + "/STK/08/kepler_states.txt"
    ...
    def test_run_7(self):
        ...
        stk_sat_state_fl = self.dir_path + "/STK/07/kepler_states.txt"
