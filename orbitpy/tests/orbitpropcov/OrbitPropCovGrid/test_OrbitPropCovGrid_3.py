"""Unit tests for :class:`orbitpy.orbitpropcov.OrbitPropCovGrid` class covering checks on coverage by rectangular sensors.
"""
'''
...
class TestOrbitPropCovGrid(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.default_pcp = PropagationCoverageParameters(
                        ...
                        sen_fov_geom="RECTANGULAR", # 15 deg AT x 25 deg CT
                        sen_orien="1,2,3,0,0,0",
                        sen_clock="31.3107,148.6893,211.3107,-31.3107", 
                        sen_cone="14.5466,14.5466,14.5466,14.5466", 
                        purely_sidelook = 0, 
                        yaw180_flag = 0, 
    ...
    def test_run_2(self):
        ...
        self.assertEqual(data3["accessTimeIndex"][0], 58)

        self.assertEqual(data1["gpi"][0], 1436)
        self.assertEqual(data1["accessTimeIndex"][0], 96)

        self.assertEqual(data2["gpi"][25], 1436)
        self.assertEqual(data2["accessTimeIndex"][25], 129)
