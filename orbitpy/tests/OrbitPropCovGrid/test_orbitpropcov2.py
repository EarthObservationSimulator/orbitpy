"""Unit tests for orbitpy.orbitpropcov.OrbitPropCovGrid class covering checks on coverage by conical sensors.
...
class TestOrbitPropCovGrid(unittest.TestCase):
    ...
    def test_run_2(self):
        ...
        prop_cov_param.sen_orien = "1,2,3," +  str(pitch) + "," + str(roll) + "," + str(yaw) # randomly orient with positive roll
        # run the propagator
        opc_grid = OrbitPropCovGrid(prop_cov_param)
        opc_grid.run()
        sat_acc_fl = prop_cov_param.sat_acc_fl
