...
GMAT Test_01_SC.ECC = 2.495631530965427e-16;
GMAT Test_01_SC.INC = 90;
GMAT Test_01_SC.RAAN = 180;
GMAT Test_01_SC.AOP = 0;
GMAT Test_01_SC.TA = 360;
...
GMAT DefaultOrbitView.UpperLeft = [ 0.2788018433179724 0.05225225225225225 ];
GMAT DefaultOrbitView.Size = [ 0.9953917050691244 0.9441441441441442 ];
...
GMAT DefaultGroundTrackPlot.UpperLeft = [ 0.2788018433179724 0.05225225225225225 ];
GMAT DefaultGroundTrackPlot.Size = [ 0.9953917050691244 0.9441441441441442 ];
