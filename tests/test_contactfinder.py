...
class TestContactFinder(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # sentinel1A
        cls.spcA = Spacecraft.from_dict({"name":"sentinel1A", "orbitState": {"date":{"@type":"GREGORIAN_UT1", "year":2021, "month":1, "day":28, "hour":13, "minute":29, "second":2}, \
        ...
        # sentinel1B
        cls.spcB = Spacecraft.from_dict({"name":"sentinel1B", "orbitState": {"date":{"@type":"GREGORIAN_UT1", "year":2021, "month":1, "day":28, "hour":12, "minute":38, "second":58}, \
        ...
        cls.spcC = Spacecraft.from_dict({"name":"testSat", "orbitState": {"date":{"@type":"GREGORIAN_UT1", "year":2021, "month":1, "day":28, "hour":13, "minute":29, "second":2}, \
        ...
        cls.spcD = Spacecraft.from_dict({"name":"testSat", "orbitState": {"date":{"@type":"GREGORIAN_UT1", "year":2021, "month":1, "day":28, "hour":13, "minute":29, "second":2}, \
