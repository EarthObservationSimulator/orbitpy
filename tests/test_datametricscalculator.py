...
class TestDataMetricCalculator(unittest.TestCase):
    ...
    def test_search_access_file_info(self):
        ...
        self.assertEqual(o.search_access_file_info(sensor_id='bs3', mode_id=0), ('bs3', 0, "C:/workspace/acc3_0.csv"))
        self.assertEqual(o.search_access_file_info(sensor_id='bs3', mode_id=1), ('bs3', 1, "C:/workspace/acc3_1.csv"))
        self.assertEqual(o.search_access_file_info(sensor_id='bs3', mode_id=None), ('bs3', 0, "C:/workspace/acc3_0.csv"))

        self.assertEqual(o.search_access_file_info(sensor_id='bs1', mode_id=None), ('bs1', spc3_bs1_mode_id, "C:/workspace/acc1_0.csv"))
        self.assertEqual(o.search_access_file_info(sensor_id='bs1', mode_id=spc3_bs1_mode_id), ('bs1', spc3_bs1_mode_id, "C:/workspace/acc1_0.csv"))
    ...
    def test_execute_0_1(self):
        ...
        self.grid_cov_calc.execute(sensor_id='bs1', mode_id=None, use_field_of_regard=False, out_file_access=out_file_access)
    ...
    def test_execute_0_2(self):
        ...
        self.pnt_opt_calc.execute(sensor_id=None, mode_id=None, out_file_access=out_file_access)
