...
Metric 3 = 0.0
/mnt/hgfs/Workspace/orbits/tests/validation/test_coverage_GridCoverage_with_STK.py:77: RuntimeWarning: invalid value encountered in true_divide
...
class TestOrbitPropCovGrid(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        out_dir2 = os.path.join(dir_path,'temp/test_coverage_GridCoverage_with_STK')
    ...
    def test_run_1(self):
        ...
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/01/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/Global_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/01/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/01/acc"
        ...
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/Global_Grid_1.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/01/acc',grid_fl)
    ...
    def test_run_2(self):
        ...
        # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/02/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        ...
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/Global_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/02/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/02/acc"
        ...
        # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/Global_Grid_2.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/02/acc',grid_fl)
    ...
    def test_run_3(self):
        """Test a near-equatorial orbit on a global grid with a 5 deg conical sensor."""
         ...
         # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/03/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        ...
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/Global_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/03/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/03/acc"
        ...
        cov.execute(out_file_access=acc_fl)
         ...
         # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/Global_Grid_3.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/03/acc',grid_fl)
    ...
    def test_run_4(self):
        ...
        # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/04/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/04/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/04/acc"
        ...
        # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid_4.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/04/acc',grid_fl)
    ...
    def test_run_5(self):
        ...
        # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/05/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        ...
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/05/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/05/acc"
        ...
        # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid_5.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/05/acc',grid_fl)
    ...
    def test_run_6(self):
        ...
        # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/06/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        ...
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/06/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/06/acc"
        ...
        cov.execute(out_file_access=acc_fl)
         ...
         # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid_6.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/06/acc',grid_fl)
    ...
    def test_run_7(self):
        ...
        # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/07/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/Equatorial_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/07/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/07/acc"
        ...
        cov.execute(out_file_access=acc_fl)
         ...
         # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/Equatorial_Grid_7.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/07/acc',grid_fl)
    ...
    def test_run_8(self):
        ...
        # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/08/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        ...
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/Equatorial_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/08/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/08/acc"
        ...
        # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/Equatorial_Grid_8.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/08/acc',grid_fl)
    ...
    def test_run_9(self):
        ...
        # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/09/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        ...
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/Equatorial_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/09/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/09/acc"
        ...
        # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/Equatorial_Grid_9.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/09/acc',grid_fl)
    ...
    def test_run_10(self):
        ...
        # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/10/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        ...
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/10/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/10/acc"
        ...
        # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid_10.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/10/acc',grid_fl)
    ...
    def test_run_11(self):
        ...
        # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/11/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        ...
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/11/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/11/acc"
        ...
        # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid_11.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/11/acc',grid_fl)
    ...
    def test_run_12(self):
        ...
        # Prepare the output directory
        out_dir = os.path.join(self.dir_path,'temp/test_coverage_GridCoverage_with_STK/12/')
        if os.path.exists(out_dir):
            shutil.rmtree(out_dir)
        os.makedirs(out_dir)
        ...
        # Setup IO file paths
        grid_fl = self.dir_path + "/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid"
        state_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/12/state"
        acc_fl = self.dir_path + "/temp/test_coverage_GridCoverage_with_STK/12/acc"
        ...
        cov.execute(out_file_access=acc_fl)
         ...
         # Construct coverage objects to verify output
        STKCoverage = Coverage.STKCoverage(self.dir_path + '/STK/test_coverage_GridCoverage_with_STK/Accesses/US_Grid_12.cvaa')
        OrbitPyCoverage = Coverage.OrbitPyCoverage(self.dir_path + '/temp/test_coverage_GridCoverage_with_STK/12/acc',grid_fl)
