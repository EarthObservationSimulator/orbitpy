...
BEGIN Scenario
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 68616000
            LaunchWindowStop		 68616000
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 28 Jul 2020 16:00:00.000000000
                    Stop		 29 Jul 2020 16:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
...
<SCOPE>
    <VAR name = "ClutterMap">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                CurrentTime		 26 May 2018 16:26:20.000000000
                Direction		 Forward
                UpdateDelta		 10
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        PrimaryBody		 Earth
                        SecondaryBody		 Sun
                        CenterLatitude		 -0.967836191449412
                        CenterLongitude		 143.2340477602561
                        ...
                        BEGIN ZoomLocations
                            BEGIN ZoomLocation
                                CenterLat		 -0.967836191449412
                                CenterLon		 143.2340477602561
                                ZoomWidth		 15.90509007636225
                                ZoomHeight		 10.46695266054722
                            END ZoomLocation
                        END ZoomLocations
    ...
    BEGIN References
        Instance *
            *		
            CoverageDefinition/Equatorial_Grid		
            CoverageDefinition/Global_Grid		
            CoverageDefinition/US_Grid		
        END Instance
        Instance AreaTarget/United_States
            AreaTarget/United_States		
            CoverageDefinition/US_Grid		
        END Instance
        Instance CoverageDefinition/Equatorial_Grid
            CoverageDefinition/Equatorial_Grid		
        END Instance
        Instance CoverageDefinition/Global_Grid
            CoverageDefinition/Global_Grid		
        END Instance
        Instance CoverageDefinition/US_Grid
            CoverageDefinition/US_Grid		
        END Instance
        ...
        Instance Satellite/Satellite3
            ...
            Satellite/Satellite3/Sensor/Sensor21		
        END Instance
        Instance Satellite/Satellite3/Sensor/Sensor21
            CoverageDefinition/Global_Grid		
            Satellite/Satellite3/Sensor/Sensor21		
        END Instance
    END References
