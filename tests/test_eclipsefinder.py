...
class TestEclipseFinder(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.jaxel = Spacecraft.from_dict({"name":"Jaxel", "orbitState": {"date":{"@type":"GREGORIAN_UT1", "year":2018, "month":12, "day":15, "hour":0, "minute":0, "second":0}, \
        ...
        cls.sentinel1A = Spacecraft.from_dict({"name":"sentinel1A", "orbitState": {"date":{"@type":"GREGORIAN_UT1", "year":2021, "month":1, "day":28, "hour":13, "minute":29, "second":2}, \
