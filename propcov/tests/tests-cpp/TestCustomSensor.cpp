...
INSTANTIATE_TEST_CASE_P(ChkTargVis, CheckTargetVisibilityTestFixture, testing::Values(
    ...
    // last point (cone,clock) need not be the same as the first point. Is this really OK?
    std::make_tuple(Rvector(19, 30*PI/180, 30*PI/180, 30*PI/180, 30*PI/180, 
          30*PI/180, 30*PI/180, 30*PI/180, 30*PI/180, 30*PI/180, 30*PI/180, 
          30*PI/180, 30*PI/180, 30*PI/180, 30*PI/180, 30*PI/180, 30*PI/180, 
          30*PI/180, 30*PI/180, 30*PI/180),
          Rvector(19, 0, 0.330693963535768, 0.661387927071536, 0.992081890607304, 1.32277585414307,
          1.65346981767884, 1.98416378121461, 2.31485774475038, 2.64555170828614, 2.97624567182191,
          3.30693963535768, 3.63763359889345, 3.96832756242922, 4.29902152596499, 4.62971548950075,
          4.96040945303652, 5.29110341657229, 5.62179738010806, 5.95249134364382),
    ...
    std::make_tuple(Rvector(4, 15.79322415135941*PI/180, 15.79322415135941*PI/180, 15.79322415135941*PI/180, 15.79322415135941*PI/180),
          Rvector(4, 71.98186515628623*PI/180, 108.01813484371377*PI/180, 251.98186515628623*PI/180, 288.01813484371377*PI/180),
